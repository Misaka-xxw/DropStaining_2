        ...
        return profiles.Select(x => new LiquidClassResponse(
                ...
                x.Versions
                    ...
                    .Select(version => new LiquidClassVersionResponse(
                        ...
                        version.AspiratePostDelayMs,
                        version.SystemTrailingAirGapUl,
                        version.DispenseLiquidDetectionEnabled,
                        version.DispensePostDelayMs,
                        version.DispenseRetractSpeedUmPerSecond,
                        version.TrailingAirGapAfterEachDispenseEnabled,

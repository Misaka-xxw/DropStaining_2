...
public sealed record LiquidClassVersionResponse(
    ...
    int AspiratePostDelayMs,
    int SystemTrailingAirGapUl,
    bool DispenseLiquidDetectionEnabled,
    int DispensePostDelayMs,
    int DispenseRetractSpeedUmPerSecond,
    bool TrailingAirGapAfterEachDispenseEnabled,
    DateTimeOffset CreatedAtUtc,
    DateTimeOffset? PublishedAtUtc,
